...
- Update Connection Strings:
  ...
  | ClassifiedAds.IdentityServer | [appsettings.json](../IdentityServer/OpenIddict/ClassifiedAds.IdentityServer/appsettings.json) | ConnectionStrings:ClassifiedAds | Identity
...
- Run Migration:
  + Option 1: Using dotnet cli:
    ...
    + Navigate to [Identity.Api](Services.Identity/ClassifiedAds.Services.Identity.Api/) and run these commands:
      ...
      ```
    + Navigate to [ClassifiedAds.IdentityServer](../IdentityServer/OpenIddict/ClassifiedAds.Migrator/) and run these commands:
      ```
      dotnet ef migrations add Init --context ConfigurationDbContext -o Migrations/ConfigurationDb
  ...
  + Option 2: Using Package Manager Console:
	...
	+ Select **Identity.Api** as Default Project and run these commands:
      ...
      ```
	+ Select **../IdentityServer/OpenIddict/ClassifiedAds.Migrator** as Default Project and run these commands:
      ```
      Add-Migration -Context ConfigurationDbContext Init -OutputDir Migrations/ConfigurationDb
