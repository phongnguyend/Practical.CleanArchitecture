...
COPY ./Services.Identity/ClassifiedAds.Services.Identity.AuthServer/*.csproj ./Services.Identity/ClassifiedAds.Services.Identity.AuthServer/
RUN dotnet restore ./Services.Identity/ClassifiedAds.Services.Identity.AuthServer/ClassifiedAds.Services.Identity.AuthServer.csproj

# Copy everything else and build ClassifiedAds
COPY . ./
RUN dotnet publish ./Services.Identity/ClassifiedAds.Services.Identity.AuthServer/ClassifiedAds.Services.Identity.AuthServer.csproj -c Release -o out
...
ENTRYPOINT ["dotnet", "ClassifiedAds.Services.Identity.AuthServer.dll"]