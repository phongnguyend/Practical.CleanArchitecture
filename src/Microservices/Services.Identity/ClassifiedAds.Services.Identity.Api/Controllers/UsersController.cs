...
public class UsersController : ControllerBase
{
    ...
    public async Task<ActionResult> SendResetPasswordEmail(Guid id)
    {
        ...
        {
            var token = await _userManager.GeneratePasswordResetTokenAsync(user);
            var resetUrl = $"{_configuration["Authentication:IdentityServer:Authority"]}/Account/ResetPassword?token={HttpUtility.UrlEncode(token)}&email={user.Email}";
    ...
    public async Task<ActionResult> SendConfirmationEmailAddressEmail(Guid id)
    {
        ...
        if (user != null)
        {
            ...
            var confirmationEmail = $"{_configuration["Authentication:IdentityServer:Authority"]}/Account/ConfirmEmailAddress?token={HttpUtility.UrlEncode(token)}&email={user.Email}";
