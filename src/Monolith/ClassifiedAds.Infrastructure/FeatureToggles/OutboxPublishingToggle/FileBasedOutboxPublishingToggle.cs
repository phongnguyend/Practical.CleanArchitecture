...
public class FileBasedOutboxPublishingToggle : IOutboxPublishingToggle
{
    ...
    {
        var filePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Practical.CleanArchitecture", "FeatureToogles", "outbox_publishing_disabled.txt");
